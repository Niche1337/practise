#Description
#In mathematics the regular paperfolding sequence, 
...
#The sequence takes its name from the fact that it represents the sequence of left 
#and right folds along a strip of paper that is folded repeatedly in half in the same direction. 
#If each fold is then opened out to create a right-angled corner, 
