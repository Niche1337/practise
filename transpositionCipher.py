...
#your theory-of-under-water-basket-weaving professor is really boring. 
#He's also very nosy. 
#In order to pass the time during class, you like sharing notes with your best friend sitting across the aisle. 
...
#you're going to write a program which will encrypt the notes for you. 
#You've decided a transposition cipher is probably the best suited method for your purposes.
#
...
#
#Specifically, we will be implementing a type of route cipher today. 
#In a route cipher the text you want to encrypt is written out in a grid, and then arranged in a given pattern. 
#The pattern can be as simple or complex as you'd like to make it.
#
#Task
#For our purposes today, your program should be able to accommodate two input paramters: 
#    Grid Dimensions, and Clockwise or Counterclockwise Rotation. To make things easier, 
#    your program need only support the Spiral route from outside to inside.
#
#Example
#Take the following message as an example:
#
#WE ARE DISCOVERED. FLEE AT ONCE
#Given inputs may include punctuation, however the encrypted text should not. 
#Further, given text may be in all caps, all lower case, or a mix of the two. The encrypted text must be in all caps.
#
...
#
#Encryption begins at the top right. 
#Your route cipher must support a Spiral route around the grid from outside to the inside in either a 
...
#Beginning with the C at the top right of the grid, you spiral clockwise along the outside, 
#so the next letter is E, then X, and so on eventually yielding the output above.
#
#Input Description
...
#
#
##gets rid of punctuation and whitespaces, in addition to making everthing uppercase   
...
#    return s
#  
##Grid Fucntion for strings
#def gridMaker(sentence,x,y):
#    
#    grid = [[0 for a in range(x)] for b in range(y)]
#    
#    print(grid)
#
#x = "For lunch let's have peanut-butter and bologna sandwiches"
# 
#gridMaker(stripper(x), 4,12)
